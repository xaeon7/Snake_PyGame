...
class SNAKE:
        ...
        for index, block in enumerate(self.body):
            ...
            if index == 0:
                ...
                if previous_block.x == next_block.x:
                    ...
                    if next_block.y == -1 and previous_block.x == -1 or next_block.x == -1 and previous_block.y == -1:
    ...
    def update_head_graphics(self):
        ...
        if head_direction.x == -1:
            self.head = self.head_right
        elif head_direction.x == 1:
            self.head = self.head_left
        elif head_direction.y == -1:
    ...
    def update_tail_graphics(self):
        ...
        if tail_direction.x == -1:
            self.tail = self.tail_right
        elif tail_direction.x == 1:
            self.tail = self.tail_left
        elif tail_direction.y == -1:
